...
/**
 * Originally copyright Google Inc, as below. Original code released under the Apache License
 * version 2.0.
 * <p>
        ...
        for (int i = input.length() - 1; i >= 0; i--) {
            ...
            if (alphaIndex == -1) {
                throw new IllegalArgumentException(
                        "In Base58Tool.decodeToBigInteger(), Illegal character "
                                + input.charAt(i) + " at index " + i
                                + ". Throwing new IlleglArgumentException.");
            }
